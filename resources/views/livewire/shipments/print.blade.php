<?php
/** @var \App\Models\Shipment[] $shipments */
/** @var \App\Models\ShipmentItem[] $shipmentItems */
    ...
    <div class="tm_invoice_wrap">
        <div class="tm_invoice tm_style1 tm_type1" id="tm_download_section">
            <div class="tm_invoice_in">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td class="tm_width_3 tm_border_top_0">
                                        ...
                                        <p>{{ $sale->contact->name }}</p>
                                        <p>{{ $sale->contact->second_address }}</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="tm_width_3 tm_border_top_0 tm_border_left tm_accent_border_20 font_12">
                                        Merkez
                                ...
                                <tr>
                                    ...
                                    <td class="tm_width_3 tm_border_top_0 tm_border_left tm_accent_border_20  ">
                                        <div class="tm_text_right font_12" style="position: absolute">
                                            <b> Belge No: {{ $shipment->shipment_no }}</b><br>
                                            <b> Sipariş No:@if($sale)
                                                    {{ $sale->sales_no }}
                                                    <!-- $sale'in diğer özelliklerini de kullanabilirsiniz -->
                                                @else
                                                    Satış bilgisi bulunamadı
                                                @endif </b><br>
                                            <b> Tarih: {{ $shipment->created_at->format('d-m-Y') }}</b><br>
                                            <b> Müş. Kodu: {{ $shipment->contact->code }}</b>
                                        </div>
                                    </td>
                ...
                <p style="display: block;text-align: center;padding-top: 60px; margin-top: 50px;"><b class="tm_primary_color">
                        SEVK İRSALİYESİ </b>
                </p>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($shipmentItems as $shipmentItem)
                                        ...
                                        <tr class="line">
                                            <td class="tm_width_2 siparis  font_siparis">{{ $shipmentItem->product->stock_code }}</td>
                                            <td class="tm_width_2 siparis font_9 ">{{ $shipmentItem->product->name }}</td>
                                            <td class="tm_width_3 siparis font_siparis "></td>
                                            <td class="tm_width_5 siparis font_siparis"> {{ $shipmentItem->variant->getVariantName() }} </td>
                                            <td class="tm_width_9 siparis font_siparis ">{{ $shipmentItem->shipped_qty }}</td>
