...
new class extends Component {
    ...
    {
        $this->fill($this->priceList);

        $this->prefix = \App\Enums\PriceListType::from($this->type)->sign();
    }
    ...
    public function save(): void
    {
        ...
        $data = $this->validate();
        $attribute = $this->priceList->update($data);

        $this->success('Fiyat Listesi  güncdellendi.', redirectTo: '/price-lists');
...
<div>
    <x-header title="Fiyat Listesini Güncelle" separator/>
    <x-form wire:submit="save">
        <div class="lg:grid grid-cols-5">
            <div class="col-span-1">
                <x-header title="Fiyat Listesi" subtitle="Fiyat bilgilerini giriniz" size="text-2xl"/>
            </div>
