                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="tm_width_6 border_0 " style="padding-left:120px;">
                                        ...
                                        <div class="font_firma"><b>Teslim Tarihi: </b>   @if($purchase->deadline_at)
                            ...
                            <table>
                                ...
                                @foreach($purchase->items as $purchaseItem)
                                    @foreach($purchaseItem->variants()->get() as $purchaseVariant)
                                        ...
                                        <tr class="line" style="display: none" >
                                            <td class="tm_width_2 siparis font_firma ">{{ $purchaseItem->product->stock_code }}</td>
                                            <td class="tm_width_7 siparis font_firma ">{{ $purchaseItem->product->name }}</td>
                                ...
                                @foreach($purchase->items as $purchaseItem)
                                    ...
                                    <tr class="line">
                                        ...
                                        <td class="tm_width_9 siparis font_siparis">{{ $purchaseItem->qty }} {{ $purchaseItem->product->unit->name }}</td>
                                        @if ($type == \App\Enums\Proposal\PdfPrintType::WITH_PRICE->value)
                                            <td class="tm_width_1 siparis tm_text_right font_siparis">{{ format_number($purchaseItem->unit_price) }}</td>
                                            <td class="tm_width_1 siparis tm_text_right font_siparis">{{ format_number($purchaseItem->qty * $purchaseItem->unit_price) }}</td>
                                        @endif
                                    </tr>
                                ...
                                <tr class="line">
                                    <td class="tm_width_2 siparis font_firma"></td>
                                    <td class="tm_width_7 siparis font_firma"></td>

                                    <td class="tm_width_5 siparis font_siparis"></td>

                                    <td class="tm_width_9 siparis font_siparis">{{ $purchase->quantity }}</td>

                                        <td class="tm_width_1 siparis tm_text_right font_siparis"></td>
                                        <td class="tm_width_1 siparis tm_text_right font_siparis"></td>
