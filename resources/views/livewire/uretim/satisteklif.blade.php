            ...
            <div class="tm_invoice_in">
                ...
                <div class="tm_invoice_head tm_top_head tm_mb15 tm_align_center">
                    ...
                    <div class="tm_invoice_right">
                        <p>Tarih: 03-07-2024</p>
                        <p class="tm_mb2"><b class="tm_primary_color">
                            </b>
                        </p>

                        <p>Teklif No: #T55091 </p>
                        <p class="tm_mb2"><b class="tm_primary_color">
                            </b>
                        </p>
                ...
                <div>
                    <p  style="display: block;text-align: center;margin-bottom: 30px"><b class="tm_primary_color">
                             SATIŞ TEKLİF FORMU </b>
                    </p>


                  <p style="display: block;text-align: left;margin-bottom: 10px"> <b>&nbsp &nbsp &nbsp &nbsp İhitiyaçlarınıza uygun ürün bilgileri ile sevkiyat ve ödeme koşulları aşağıda belirtilmiştir.
                    İlginize teşekkür eder, bilgi ve görüşlerinize sunarız. </b> <br><br></p>
                    ...
                    <div class="tm_border  tm_accent_border_20 tm_border_top_0">
                        <div class="tm_table_responsive">
                            <table>
                                ...
                                <tr>
                                    <td class="tm_width_6 tm_accent_border_20">
                                        <b class="tm_primary_color tm_medium">Geçerlilik Tarhi </b>
                                    </td>
                                    <td class="tm_width_6 tm_border_left tm_accent_border_20">
                                        <p class="tm_primary_color tm_medium">  07-07-2024 </p>
                                    </td>
                                </tr>

                                <tr>
                                    <td class="tm_width_6 tm_accent_border_20">
                                        <b class="tm_primary_color tm_medium">Kargo </b>
                                    </td>
                                    <td class="tm_width_6 tm_border_left tm_accent_border_20">
                                        <p class="tm_primary_color tm_medium">  ARAS KARGO </p>
                                    </td>
                                </tr>

                                <tr>
                                    <td class="tm_width_6 tm_accent_border_20">
                                        <b class="tm_primary_color tm_medium">Ödeme </b>
                                    </td>
                                    <td class="tm_width_6 tm_border_left tm_accent_border_20">
                                        <p class="tm_primary_color tm_medium">  Müşteriye Ait </p>
                                    </td>
                                </tr>
