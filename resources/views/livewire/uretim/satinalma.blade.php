        ...
        <div class="tm_invoice tm_style1 tm_type1" id="tm_download_section">
            <div class="tm_invoice_in">
                ...
                <div class="tm_invoice_head tm_top_head tm_mb15 tm_align_center">
                    ...
                    <div class="tm_invoice_left">
                        <p>SN.İLGİLİ: İLKKAN ÇANAKÇI</p>
                        <p class="tm_mb2"><b class="tm_primary_color">
                            </b>
                        </p>

                        <p>Tel: 0312 309 03 44 </p>
                        <p class="tm_mb2"><b class="tm_primary_color">
                            </b>
                        </p>
                    ...
                    <div class="tm_invoice_right">
                        <p>Sipariş Tarihi: 03-07-2024</p>
                        <p class="tm_mb2"><b class="tm_primary_color">
                            </b>
                        </p>

                        <p>Satınalma Sipariş No: #T55091 </p>
                        <p class="tm_mb2"><b class="tm_primary_color">
                            </b>
                        </p>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td class="tm_width_6 tm_border_top_0">
                                        <b class="tm_primary_color tm_medium">Sipariş No: </b>
                                    </td>
                                    <td class="tm_width_8 tm_border_top_0 tm_border_left tm_accent_border_20">
                                        <p class="tm_primary_color tm_medium"> P88655</p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="tm_width_6 tm_accent_border_20">
                                        <b class="tm_primary_color tm_medium">Satış Temsilcisi </b>
                                    </td>
                                    <td class="tm_width_8 tm_border_left tm_accent_border_20">
                                        <p class="tm_primary_color tm_medium"> Bayram Demir </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="tm_width_6 tm_accent_border_20">
                                        <b class="tm_primary_color tm_medium"> Firma </b>
                                    </td>
                                    <td class="tm_width_8 tm_border_left tm_accent_border_20">
                                        <p class="tm_primary_color tm_medium">  Berka İş Güvenlik</p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="tm_width_6 tm_accent_border_20">
                                        <b class="tm_primary_color tm_medium"> Teslimat Adres </b>
                                    </td>
                                    <td class="tm_width_8 tm_border_left tm_accent_border_20">
                                        <p class="tm_primary_color tm_medium">  Çavuşoğlu, Kültür Cd. No:34, 34873 Kartal/İstanbul</p>
                                    </td>
                                </tr>

                                <tr>
                                    <td class="tm_width_6 tm_accent_border_20">
                                        <b class="tm_primary_color tm_medium">Telefon </b>
                                    </td>
                                    <td class="tm_width_8 tm_border_left tm_accent_border_20">
                                        <p class="tm_primary_color tm_medium">  0550 240 90 71 </p>
                                    </td>
                                </tr>

                                <tr>
                                    <td class="tm_width_6 tm_accent_border_20">
                                        <b class="tm_primary_color tm_medium">Vergi Dairesi </b>
                                    </td>
                                    <td class="tm_width_8 tm_border_left tm_accent_border_20">
                                        <p class="tm_primary_color tm_medium">  Pendik VD </p>
                                    </td>
                                </tr>

                                <tr>
                                    <td class="tm_width_6 tm_accent_border_20">
                                        <b class="tm_primary_color tm_medium">Vergi No </b>
                                    </td>
                                    <td class="tm_width_8 tm_border_left tm_accent_border_20">
                                        <p class="tm_primary_color tm_medium">  P03256978 </p>
                                    </td>
                                </tr>
                    ...
                    <div class="">
                        <div class="tm_table_responsive">
                            <table>
                                <thead>
                                <tr class="">
                                    <th class="tm_width_7 tm_semi_bold ">Açıklama</th>
                                    <th class="tm_width_1 tm_semi_bold ">Beden</th>
                                    <th class="tm_width_1 tm_semi_bold ">Miktar</th>

                                    <th class="tm_width_7 tm_semi_bold ">Birim Fiyat</th>
                                    <th class="tm_width_7 tm_semi_bold ">Vergi Oranı</th>

                                    <th class="tm_width_7 tm_semi_bold tm_text_right ">Tutar</th>
                                ...
                                <tr>
                                    <td class="tm_width_7 siparis font_siparis">İŞ PANTALONU PANAMA KANVAS GRİ-SİYAH,  </td>
                                    <td class="tm_width_1 siparis font_siparis ">M</td>
                                    <td class="tm_width_1 siparis font_siparis ">62</td>

                                    <td class="tm_width_7 siparis font_siparis">23,00 TL</td>
                                    <td class="tm_width_7 siparis ">% 10</td>

                                    <td class="tm_width_7 siparis tm_text_right">3.426,50</td>

                                </tr>

                                <tr>
                                    <td class="tm_width_7 siparis font_siparis">İŞ PANTALONU PANAMA KANVAS GRİ-SİYAH,  </td>
                                    <td class="tm_width_1 siparis font_siparis ">L</td>
                                    <td class="tm_width_1 siparis font_siparis ">62</td>
                                ...
                                <tr>
                                    <td class="tm_width_3 siparis font_siparis">İŞ PANTALONU PANAMA KANVAS GRİ-SİYAH,</td>
                                    <td class="tm_width_1 siparis font_siparis ">XL</td>
                                    <td class="tm_width_1 siparis font_siparis ">62</td>

                                    <td class="tm_width_2 siparis font_siparis">23,00 TL</td>
                                    <td class="tm_width_1 siparis ">% 10</td>
                    ...
                    <div class="tm_invoice_footer tm_border_top tm_mb15 tm_m0_md">
                        ...
                        <div class="tm_right_footer">
                            <table class="tm_mb15">
                                <tbody>
                                <tr class="tm_gray_bg ">
                                    <td class="tm_width_3 tm_primary_color ">Toplam Miktar </td>

                                    <td class="tm_width_3 tm_primary_color  tm_text_right">186</td>
                                </tr>
                                <tr class="tm_gray_bg ">
